...
export function NetworkView({ corridors, opportunities, selected, selectedOpportunity, activeIds, built, simulation, routedFlows, onSelect, onSelectOpportunity }: NetworkViewProps) {
      ...
      <div className="network-view__primary-grid">
        <article className="network-view__panel network-view__map-panel">
          ...
          <div className="network-view__map-stage">
            <TorontoMap opportunities={visibleOpportunities} selected={selectedOpportunity} activeIds={activeIds} built={built} showAllRoutes onSelect={onSelectOpportunity} routedFlows={routedFlows} />
